...
def reconstruct_missing_cell_bboxes(
    ...
    # Some PubTabNet tables contain rowspans in the last explicit <tr>, so the
    # finest-grained grid can extend beyond the number of literal row tags.
    # Size the boundary arrays from the actual occupied span extents.
    if records:
