#!/bin/bash
#SBATCH --job-name=tf_ptn_recon20_fix
...
/cluster/home/trinhwin/vt2/docling/.venv/bin/python -u \
  ...
  --filenames-file /cluster/home/trinhwin/vt2/docling/results/tableformer_pubtabnet_hf_bbox_reconstruction/old_full_empty_heavy20_filenames.txt \
  ...
  --output-dir /cluster/home/trinhwin/vt2/docling/results/tableformer_pubtabnet_hf_bbox_reconstruction/smoke_20_reconstructed_empty_heavy_fixed_parser
