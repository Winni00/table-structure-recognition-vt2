#!/bin/bash
#SBATCH --job-name=paper_ftn10kptn_teds
#SBATCH --time=2:00:00
#SBATCH --tasks=1
#SBATCH --nodes=1
...
out_dir = Path("/cluster/home/trinhwin/vt2/docling/results/tflop_paper_collection_ocr_style_707_ftn10k_ptnstyle")
...
summary = {
    "run_dir": str(out_dir),
    "model_variant": "FTN 10K checkpoint trained with first-row-the-head PTN-style section labels",
...
(out_dir / "README.md").write_text(
    "# Paper Collection FTN 10K PTN-style-section Eval\n\n"
