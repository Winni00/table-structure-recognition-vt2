...
OUT_DIR=/cluster/home/trinhwin/vt2/docling/results/tflop_paper_collection_updated_crops_pymupdf_text_public
...
echo "Merged PyMuPDF-text inference and computed official plus GT-canonicalized TEDS/TEDS-S."
