#!/bin/bash
#SBATCH --job-name=tflop_pubtabnet_test
...
mkdir -p logs results/tflop_pubtabnet_test_9064
...
SAVE_DIR=/cluster/home/trinhwin/vt2/docling/results/tflop_pubtabnet_test_9064
