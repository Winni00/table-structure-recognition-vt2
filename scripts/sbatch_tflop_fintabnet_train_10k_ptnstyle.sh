#!/bin/bash
#SBATCH --job-name=tflop_ftn10k_ptnstyle
...
TRAIN_OUT=/cluster/home/trinhwin/vt2/docling/results/tflop_fintabnet_train_10k_ptnstyle_training
...
$PY_TFLOP scripts/train_tflop_single_gpu_train_only.py \
  ...
  exp_name=tflop_fintabnet_train_20k_ptnstyle \
  exp_version=from_public_checkpoint_10000steps_trainonly \
...
echo "Finished 10K PTN-style-section FTN fine-tune in $TRAIN_OUT"
