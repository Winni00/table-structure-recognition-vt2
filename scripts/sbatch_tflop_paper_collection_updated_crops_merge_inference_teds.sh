...
OUT_DIR=/cluster/home/trinhwin/vt2/docling/results/tflop_paper_collection_updated_crops_ocr_style_public
...
echo "Merged inference and computed official plus GT-canonicalized TEDS/TEDS-S."
