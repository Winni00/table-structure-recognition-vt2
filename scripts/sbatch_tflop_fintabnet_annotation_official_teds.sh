#!/bin/bash
#SBATCH --job-name=teds_ftn_tflop_official
#SBATCH --time=6:00:00
#SBATCH --tasks=1
#SBATCH --nodes=1
...
RUN_DIR=/cluster/home/trinhwin/vt2/docling/results/tflop_fintabnet_full_annotation_excl_problem_pages
OUT_DIR=/cluster/home/trinhwin/vt2/docling/results/tflop_fintabnet_full_annotation_excl_problem_pages_tflop_official_eval
...
out = Path("/cluster/home/trinhwin/vt2/docling/results/tflop_fintabnet_full_annotation_excl_problem_pages_tflop_official_eval")
...
summary = {
    ...
    "note": "No custom FTN flattening canonicalization is applied.",
}
