#!/bin/bash
#SBATCH --job-name=paper_ocr_teds
#SBATCH --time=2:00:00
#SBATCH --tasks=1
#SBATCH --nodes=1
...
OUT_DIR=/cluster/home/trinhwin/vt2/docling/results/tflop_paper_collection_ocr_style_707
...
echo "Merged inference and computed official TFLOP TEDS/TEDS-S."
