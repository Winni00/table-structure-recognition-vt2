#!/bin/bash
#SBATCH --job-name=tflop_ptn_val_ann
...
mkdir -p logs results/tflop_pubtabnet_val_annotations_full
...
OUT_DIR=/cluster/home/trinhwin/vt2/docling/results/tflop_pubtabnet_val_annotations_full
