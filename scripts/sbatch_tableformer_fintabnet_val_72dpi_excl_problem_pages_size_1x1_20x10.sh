#!/bin/bash
#SBATCH --job-name=tf_ftn_72dpi_size
...
/cluster/home/trinhwin/vt2/docling/.venv/bin/python \
  ...
  --min-cols 1 \
  --max-cols 10 \
  --output-dir /cluster/home/trinhwin/vt2/docling/results/tableformer_fintabnet_kaggle/val_72dpi_excluding_problem_pages_size_1x1_20x10
