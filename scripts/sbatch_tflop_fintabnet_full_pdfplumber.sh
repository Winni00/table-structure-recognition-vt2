#!/bin/bash
#SBATCH --job-name=tflop_fintabnet_full_pdfplumber
...
mkdir -p logs results/tflop_fintabnet_full_pdfplumber
...
OUT_DIR=/cluster/home/trinhwin/vt2/docling/results/tflop_fintabnet_full_pdfplumber
