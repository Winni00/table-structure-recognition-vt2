#!/bin/bash
#SBATCH --job-name=ftn50k_full_inf
#SBATCH --time=4:00:00
#SBATCH --tasks=1
#SBATCH --nodes=1
...
TRAIN_ROOT=/cluster/home/trinhwin/vt2/docling/results/tflop_fintabnet_train_50k_training/tflop_fintabnet_train_20k/from_ftn10k_checkpoint_50000steps_trainonly
EXP_CONFIG=${TRAIN_ROOT}/config.yaml

if [ -f /cluster/home/trinhwin/vt2/docling/results/tflop_fintabnet_train_50k_training/SKIPPED ]; then
  mkdir -p "$RUN_DIR"
  touch "$RUN_DIR/SKIPPED"
  echo "50K training was skipped by gate; skipping inference shard."
  exit 0
fi
