#!/bin/bash
#SBATCH --job-name=tflop_fintabnet_smoke5
#SBATCH --time=4:00:00
#SBATCH --tasks=1
#SBATCH --nodes=1
...
mkdir -p logs results/tflop_fintabnet_smoke
...
OUT_DIR=/cluster/home/trinhwin/vt2/docling/results/tflop_fintabnet_smoke
