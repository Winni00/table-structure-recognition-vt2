#!/bin/bash
#SBATCH --job-name=ftn100k_teds_merge
#SBATCH --time=30:00
#SBATCH --tasks=1
#SBATCH --nodes=1
...
RUN_DIR=/cluster/home/trinhwin/vt2/docling/results/tflop_fintabnet_full_annotation_excl_problem_pages_ftn100k_eval
...
FTN50K_DIR=/cluster/home/trinhwin/vt2/docling/results/tflop_fintabnet_full_annotation_excl_problem_pages_ftn50k_eval
...
ftn100k = Path("/cluster/home/trinhwin/vt2/docling/results/tflop_fintabnet_full_annotation_excl_problem_pages_ftn100k_eval")
out = ftn100k / "comparison_public_1k_10k_50k_100k_summary.json"
readme = ftn100k / "README.md"
...
summary = {
    ...
    "finetuned_100k_checkpoint_full_ftn_annotation": {
        "official_tflop_eval": official_summary(ftn100k),
        "ftn_section_canonicalized": canonical_summary(ftn100k),
    },
}
...
lines = [
    "# FTN 100K Fine-tune Full-Val Evaluation",
    "",
