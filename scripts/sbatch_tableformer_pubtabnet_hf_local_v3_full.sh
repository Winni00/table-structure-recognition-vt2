#!/bin/bash
#SBATCH --job-name=tf_ptn_local_v3_full
...
/cluster/home/trinhwin/vt2/docling/.venv/bin/python -u \
  /cluster/home/trinhwin/vt2/docling/tableformer_pubtabnet_repro_local_v3.py \
  --split val \
  --subset-size 9115 \
  --device cuda \
  --num-threads 1 \
  ...
  --output-dir /cluster/home/trinhwin/vt2/docling/results/tableformer_pubtabnet_hf_bbox_reconstruction/val_full_9115_local_v3
